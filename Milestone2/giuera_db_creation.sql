...
CREATE TABLE Course(
	...
	instructorId INT FOREIGN KEY REFERENCES Instructor(id) ON DELETE SET NULL ON UPDATE CASCADE,
);
...
CREATE TABLE Feedback(
	...
	numberOfLikes INT,
	comment VARCHAR(100),
	sid INT FOREIGN KEY REFERENCES Student(id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE StudentHasPromocode(
	...
	code VARCHAR(6) FOREIGN KEY REFERENCES Promocode(code) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE StudentAddCreditCard(
	sid INT FOREIGN KEY REFERENCES Student(id) ON DELETE CASCADE ON UPDATE CASCADE,
	creditCardNumber VARCHAR(64) FOREIGN KEY REFERENCES CreditCard(number) ON DELETE CASCADE ON UPDATE CASCADE,
