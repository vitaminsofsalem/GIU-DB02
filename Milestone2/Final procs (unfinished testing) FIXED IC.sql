...
CREATE PROC AddAnotherInstructorToCourse
	...
	@adderIns INT
AS
	INSERT INTO InstructorTeacheCourse
	SELECT @instId, @cid
	FROM InstructorTeacheCourse
...
EXEC InstructorgradeAssignmentOfAStudent
	@instrId= 2,
	@sid =1,
	@cid =1,
	@assignmentNumber =1,
...
EXEC ViewFeedbacksAddedByStudentsOnMyCourse
	@instrId = 2,
	@cid = 1
...
EXEC AddAnotherInstructorToCourse
	@instId = 1003,
	@cid = 2,
	@adderIns = 2 